...
| | |
|---|---|
| Rows (one per genome × antibiotic) | 1,525,796 (cleaning v1; v2 to v4 give 1,521,644; v5, with Genome ID read as text, gives 1,558,494 over 131,385 genomes, see §3.4) |
